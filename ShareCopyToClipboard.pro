...
UBUNTU_TRANSLATION_DOMAIN="sharecopytoclipboard.sil"
...
aptest.commands = bash $$PWD/ShareCopyToClipboard/tests/autopilot/run
aptest.depends  = sub-ShareCopyToClipboard

unittest.target   = check
unittest.commands = /usr/bin/qmltestrunner -input $$PWD/ShareCopyToClipboard/tests/unit 
unittest.depends  = sub-ShareCopyToClipboard
